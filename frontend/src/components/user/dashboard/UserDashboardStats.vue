<template>
  <!-- Row 1: Core Stats -->
  <div :class="['dashboard-core-grid grid grid-cols-1 gap-4 sm:grid-cols-2', isSimple ? 'lg:grid-cols-4' : 'lg:grid-cols-5']">
    <!-- Balance -->
    <div v-if="!isSimple" class="metric-card metric-card-primary dashboard-balance-card card p-5 lg:col-span-2">
      <div class="flex items-center gap-3">
        <div class="metric-route-icon metric-route-icon-blue rounded-lg bg-emerald-100 p-2 dark:bg-emerald-900/30">
    ...
    <div class="metric-card card p-4">
      <div class="flex items-center gap-3">
        <div class="metric-route-icon metric-route-icon-blue rounded-lg bg-blue-100 p-2 dark:bg-blue-900/30">
    ...
    <div class="metric-card card p-4">
      <div class="flex items-center gap-3">
        <div class="metric-route-icon metric-route-icon-yellow rounded-lg bg-amber-100 p-2 dark:bg-amber-900/30">
    ...
    <div class="metric-card card p-4">
      <div class="flex items-center gap-3">
        <div class="metric-route-icon metric-route-icon-red rounded-lg bg-red-100 p-2 dark:bg-red-900/30">
          <Icon name="dollar" size="md" class="text-red-600 dark:text-red-400" :stroke-width="2" />
        </div>
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') }}</p>
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="text-red-600 dark:text-red-400" :title="t('dashboard.actual')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
          ...
          <p class="text-xs">
            ...
            <span class="text-red-600 dark:text-red-400" :title="t('dashboard.actual')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
  ...
  <!-- Row 2: Token Stats -->
  <div class="dashboard-secondary-grid grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
    <!-- Today Tokens -->
    <div class="metric-card card p-4">
      <div class="flex items-center gap-3">
        <div class="metric-route-icon metric-route-icon-yellow rounded-lg bg-amber-100 p-2 dark:bg-amber-900/30">
    ...
    <div class="metric-card card p-4">
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-sm font-semibold text-blue-600 dark:text-blue-400">{{ formatTokens(stats?.tpm || 0) }}</p>
    ...
    <div class="metric-card card p-4">
      <div class="flex items-center gap-3">
        <div class="metric-route-icon metric-route-icon-red rounded-lg bg-red-100 p-2 dark:bg-red-900/30">
          <Icon name="clock" size="md" class="text-red-600 dark:text-red-400" :stroke-width="2" />
        </div>
        <div>
  ...
  <div v-if="!isSimple && platformCards.length > 0" class="dashboard-platform-panel card p-4">
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      <div
        ...
        :class="[
          'platform-data-card rounded border p-3',
          item.isOther
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <span class="font-mono text-sm text-blue-600 dark:text-blue-400" :title="t('dashboard.actual')">
...
.dashboard-core-grid > .metric-card:nth-child(2) {
  border-top-color: var(--bird-red);
}

.dashboard-core-grid > .metric-card:nth-child(3),
.dashboard-secondary-grid > .metric-card:nth-child(1) {
  border-top-color: var(--bird-yellow);
}

.dashboard-core-grid > .metric-card:nth-child(4),
.dashboard-secondary-grid > .metric-card:nth-child(3) {
  border-top-color: var(--bird-red);
}
...
.metric-card > div > div:last-child {
  min-width: 0;
}

.metric-card > div > div:last-child > p:nth-child(2) {
  margin-top: 0.35rem;
...
.metric-card-primary > div > div:first-child {
  background: rgba(255, 255, 255, 0.14) !important;
}

.metric-card-primary p,
.metric-card-primary :deep(svg) {
  color: #fff !important;
}
...
.dark .metric-card > div > div:first-child,
