<template>
  <!-- Admin-provided home content keeps the highest priority. -->
  <div v-if="hasHomeContent" class="min-h-screen">
    <iframe
      ...
      allowfullscreen
    ></iframe>
    <!-- homeContent is an explicitly trusted, admin-only setting. -->
...
import BrandRouteHome from '@/components/home/BrandRouteHome.vue'
