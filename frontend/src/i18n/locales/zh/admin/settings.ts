    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          dingTalkEnabled: '钉钉机器人告警',
          dingTalkEnabledHint: '渠道主模型连续 3 次检测失败时推送一次；恢复后再次连续失败会重新告警。',
          dingTalkWebhook: '机器人 Webhook',
          dingTalkWebhookPlaceholder: 'https://oapi.dingtalk.com/robot/send?access_token=...',
          dingTalkWebhookHint: '粘贴钉钉群自定义机器人的 Webhook 地址。',
          dingTalkSecret: '加签密钥（可选）',
          dingTalkSecretPlaceholder: 'SEC...',
          dingTalkSecretHint: '机器人启用了加签安全设置时填写。',
          secretConfiguredHint: '已配置。留空保存将保留当前值。',
          clearSaved: '清除已保存的值',
          cancelClear: '取消清除',
          clearPendingHint: '保存后将清除此值。',
          testAlert: '发送测试',
          testingAlert: '正在发送',
          saveDingTalk: '保存钉钉配置',
          savingDingTalk: '正在保存',
          testSuccess: '测试消息已发送，请在钉钉群中查看。',
          testFailed: '测试消息发送失败',
          saveSuccess: '钉钉告警配置已保存。',
          saveFailed: '钉钉告警配置保存失败',
