    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          dingTalkEnabled: 'DingTalk robot alerts',
          dingTalkEnabledHint: 'Sends one alert after 3 consecutive primary-model failures. A recovery resets the alert episode.',
          dingTalkWebhook: 'Robot webhook',
          dingTalkWebhookPlaceholder: 'https://oapi.dingtalk.com/robot/send?access_token=...',
          dingTalkWebhookHint: 'Paste the custom robot webhook from the DingTalk group.',
          dingTalkSecret: 'Signing secret (optional)',
          dingTalkSecretPlaceholder: 'SEC...',
          dingTalkSecretHint: 'Required only when signing is enabled for the robot.',
          secretConfiguredHint: 'Configured. Leave blank to keep the current value.',
          clearSaved: 'Clear saved value',
          cancelClear: 'Cancel clear',
          clearPendingHint: 'This value will be cleared when saved.',
          testAlert: 'Send test',
          testingAlert: 'Sending',
          saveDingTalk: 'Save DingTalk settings',
          savingDingTalk: 'Saving',
          testSuccess: 'Test alert sent. Check the DingTalk group.',
          testFailed: 'Failed to send the test alert',
          saveSuccess: 'DingTalk alert settings saved.',
          saveFailed: 'Failed to save DingTalk alert settings',
